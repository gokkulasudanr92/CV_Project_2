...
def cnn_model_fn(features, labels, mode):
    ...
    dropout = tf.layers.dropout(
        inputs=dense, rate=1.8521543244648558e-12, training=mode == tf.estimator.ModeKeys.TRAIN)
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
        optimizer = tf.train.GradientDescentOptimizer(learning_rate=7.174023890469743e-06)
